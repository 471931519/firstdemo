...
//      println("inviewRdd数量为" + inviewRdd.count)
      ...
      //解析成JSON对象
      val newsJSONObjectRdd = newsRdd.map(JSON.parseObject(_))
      ...
      val categoryResultRdd = CalculateUtils.getTargetResultSmooth(Constants.JOIN_CLICK_DEVICE_CATEGORY_TABLE_NAME, Constants.JOIN_INVIEW_DEVICE_CATEGORY_TABLE_NAME, Constants.TARGET_CATEGORY_TABLE_NAME, Constants.TARGET_CATEGORY_JSON_NAME, spark, yesterday)
      val secondCateResultRdd = CalculateUtils.getTargetResultSmooth(Constants.JOIN_CLICK_DEVICE_SECOND_CATE_TABLE_NAME, Constants.JOIN_INVIEW_DEVICE_SECOND_CATE_TABLE_NAME, Constants.TARGET_SECOND_CATE_TABLE_NAME, Constants.TARGET_SECOND_CATE_JSON_NAME, spark, yesterday)
      val tagResultRdd = CalculateUtils.getTargetResultSmooth(Constants.JOIN_CLICK_DEVICE_TAG_TABLE_NAME, Constants.JOIN_INVIEW_DEVICE_TAG_TABLE_NAME, Constants.TARGET_TAG_TABLE_NAME, Constants.TARGET_TAG_JSON_NAME, spark, yesterday)
      val dfromResultRdd = CalculateUtils.getTargetResultSmooth(Constants.JOIN_CLICK_DEVICE_DFROM_TABLE_NAME, Constants.JOIN_INVIEW_DEVICE_DFROM_TABLE_NAME, Constants.TARGET_DFROM_TABLE_NAME, Constants.TARGET_DFROM_JSON_NAME, spark, yesterday)
      val categoryDfromResultRdd = CalculateUtils.getTargetResultSmooth(Constants.JOIN_CLICK_DEVICE_CATEGORY_DFROM_TABLE_NAME, Constants.JOIN_INVIEW_DEVICE_CATEGORY_DFROM_TABLE_NAME, Constants.TARGET_CATEGORY_DFROM_TABLE_NAME, Constants.TARGET_CATEGORY_DFROM_JSON_NAME, spark, yesterday)
      val categoryTagResultRdd = CalculateUtils.getTargetResultSmooth(Constants.JOIN_CLICK_DEVICE_CATEGORY_TAG_TABLE_NAME, Constants.JOIN_INVIEW_DEVICE_CATEGORY_TAG_TABLE_NAME, Constants.TARGET_CATEGORY_TAG_TABLE_NAME, Constants.TARGET_CATEGORY_TAG_JSON_NAME, spark, yesterday)
